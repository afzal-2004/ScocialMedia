      ...
      <form className="" onSubmit={HandleSubmit}>
        <div className=" ">
          ...
          <input
            ...
            id="UserId"
            ref={userIdElement}
            className="shadow-sm bg-gray-5000 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light m-5 w-[90%]"
            placeholder="Userid"
          />
        </div>
        ...
        <div className="mb-5">
          ...
          <textarea
            ...
            rows={5}
            cols={20}
            className="shadow-sm bg-gray-5000 border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 
